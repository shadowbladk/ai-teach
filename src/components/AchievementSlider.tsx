      ...
      <div className="flex flex-row justify-center items-center">
        ...
        >
          {Achievement.map((item) => (
            <SwiperSlide key={item.index} className="max-w-fit mb-8">
              <div className="flex flex-col mx-20 gap-5 items-center group relative cursor-pointer">
                <div className="w-[300px] h-[300px] p-4 flex flex-col gap-4 items-center">
                  <Image
